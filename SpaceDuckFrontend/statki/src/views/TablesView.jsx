...
class Tables extends React.Component {
    ...
    componentDidMount(){
        ...
        fetch('https://' + window.location.hostname + ':' + address.shipsBackendPort + address.room + '/all')
    ...
    async addToGame(){
        ...
        try{
            const response = await fetch('https://' + window.location.hostname + ':' + address.shipsBackendPort+address.room+'/'+this.state.table.id+'/'+user.id+'/'+user.userName, {
                method: 'POST',
                headers: {
